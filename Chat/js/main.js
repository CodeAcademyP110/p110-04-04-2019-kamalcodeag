...
function SendMessage() {
    ...
    if (mainValue !== "") {
        ...
        if (mainValue[0].toUpperCase() !== mainValue[0]) {
            // let chatLineCustomer = document.createElement("div");
            chatLineCustomer.className = "p-2 d-flex align-items-center justify-content-end spec-chat-line-customer spec-chat-line-hover";
            ...
            // let chatLineSupporter = document.createElement("div");
            chatLineSupporter.className = "py-2 px-3 d-flex align-items-center spec-chat-line-supporter spec-chat-line-hover";
